namespace VisualStudioWithConsole
{
    partial class Form4
    {
        ...
        private void InitializeComponent()
        {
            ...
            // button2
            // 
            this.button2.Location = new System.Drawing.Point(175, 355);
            ...
            "Обновление адресов всех адаптеров",
            "Обновление адресов для всех подключений, имя которых начинается с \"...\"",
            "Освобождение адресов для всех подключений с соответствующим именем, например \"Про" +
                "водное подключение Ethernet 1\" ",
            "Отображение сведений обо всех секциях",
            ...
            this.textBox1.Size = new System.Drawing.Size(438, 238);
            ...
            this.label3.Text = "Введите параметр:";
            // 
            // Form4
            // 
